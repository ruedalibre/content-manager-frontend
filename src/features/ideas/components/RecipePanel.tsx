...
export default function RecipePanel({
  ...
  const handleCopyBrief = async () => {
    ...
    const lines: string[] = [
      t("briefExport.contentBrief"),
      `━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━`,
      ``,
      `${t("briefExport.idea")}: ${idea.title}`,
      ...(idea.description
        ? [`${t("briefExport.context")}: ${idea.description}`]
        : []),
      `${t("briefExport.format")}: ${session.format}`,
      ...(session.content_role
        ? [`${t("briefExport.role")}: ${session.content_role}`]
        : []),
      ``,
    ];
    ...
    aspects.forEach((aspect) => {
      ...
      const label = t(`briefExport.${aspect.key}`);
    ...
    if (session.recipe.strategic_note) {
      lines.push(`━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━`);
      lines.push(``);
      lines.push(t("briefExport.strategicNote").toUpperCase());
      lines.push(``);
      lines.push(session.recipe.strategic_note as string);
      lines.push(``);
    }
    lines.push(`━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━`);
    lines.push(`${t("briefExport.generatedBy")} Creadora`);
