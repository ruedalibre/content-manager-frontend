    ...
    sections: [
      {
        ...
        children: [
          ...
          ...(session.recipe.strategic_note
            ? [
                new Paragraph({
                  ...
                  children: [
                    new TextRun({
                      text: t("briefExport.strategicNote"),
                      font: "Arial",
                    }),
                  ],
                }),
          ...
          new Paragraph({
            ...
            children: [
              new TextRun({
                text: `${t("briefExport.generatedBy")} Creadora · ${new Date(session.created_at).toLocaleDateString()}`,
                font: "Arial",
                size: 16,
                color: "999999",
              }),
