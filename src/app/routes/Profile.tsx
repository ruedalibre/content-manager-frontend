      ...
      <section className="profile-section">
        ...
        <div className="profile-card">
            ...
            <div className="profile-field__plan">
              ...
              {trialActive && trialEndsAt && (
                <span className="profile-plan-trial">
                  {t("profile.trialEnds", { date: new Date(trialEndsAt).toLocaleDateString() })}
                </span>
              )}
            </div>
          </div>
          <div className="profile-field profile-field--readonly">
            ...
            <div>
              {isCreator ? (
                <button className="btn-secondary" type="button" onClick={openPortal} disabled={portalLoading}>
                  {portalLoading ? t("common.loading") : t("profile.manageSubscriptionCta")}
                </button>
              ) : (
                <button className="btn-primary" type="button" onClick={openPricing}>
        ...
        <div className="profile-card">
          <div className="profile-field">
            ...
            <input name="display_name" value={form.display_name} onChange={handleChange}
              placeholder={t("profile.displayNamePlaceholder")} className="profile-field__input" />
          </div>
          <div className="profile-field">
            <label className="profile-field__label">{t("profile.language")}</label>
            <div className="profile-field__language"><LanguageToggle /></div>
          </div>
          <div className="profile-field">
            <label className="profile-field__label">{t("profile.country")}</label>
            <select name="country_code" value={form.country_code} onChange={handleChange} className="profile-field__select">
          ...
          <div className="profile-field">
            ...
            <select name="timezone" value={form.timezone} onChange={handleChange} className="profile-field__select">
      ...
      <section className="profile-section">
        ...
        <div className="profile-card">
          <div className="profile-field">
            ...
            <select name="creator_role" value={form.creator_role} onChange={handleChange} className="profile-field__select">
              <option value="">{t("profile.selectRole")}</option>
              {CREATOR_ROLES.map((r) => (
                <option key={r} value={r}>{t(`profile.roles.${r}`, { defaultValue: r })}</option>
              ))}
            </select>
          </div>
          <div className="profile-field">
            <label className="profile-field__label">{t("profile.timeAvailability")}</label>
            <select name="time_availability" value={form.time_availability} onChange={handleChange} className="profile-field__select">
          ...
          <div className="profile-field">
            ...
            <select name="production_setup" value={form.production_setup} onChange={handleChange} className="profile-field__select">
              <option value="">{t("profile.select")}</option>
              {SETUP_OPTIONS.map((o) => (
                <option key={o} value={o}>
          ...
          <div className="profile-field">
            ...
            <input name="referents" value={form.referents} onChange={handleChange}
              placeholder={t("profile.referentsPlaceholder")} className="profile-field__input" />
          </div>
        </div>
      </section>
